...
define('_USERPICTURESOWNUPLOADSPOSSIBLE',	'It is possible to upload some pictures in an own user gallery');
...
define('_USERPICTURESTEMPLATENUMBERFALSE',		'Template-ID wrong or not specified');
define('_USERPICTURESCOMMENT',		'Comment for the picture');
define('_USERPICTURESDELETEPICTURE',	'Delete this picture');
define('_USERPICTURESBACKTOALLTEMPLATES',		'Back to the management of the different picture templates');
define('_USERPICTURESDISABLED',		'Uploading new pictures is deactivated for the moment.');
define('_USERPICTURESNEWPICTUREDELETEOLDFIRST',		'Renew a picture? Just delete the old one and upload the new one');
define('_USERPICTURESDELETEERROR',	'An error occured while trying to delete a picture');
define('_USERPICTURESDELETED',		'The picture was deleted');
define('_USERPICTURESCACHEPROBLEM',	'');
define('_USERPICTURESMAFILESIZEREACHED','The file is too large. Please resize the picture and upload it one more time');
define('_USERPICTURESOWNGALLERY',	'Own user gallery');
define('_USERPICTURESUPLOADLIMITREACHED'	,'You have already reached the limit of pictures a user can upload for his gallery');
define('_USERPICTURESROTATED',		'...done.');
define('_USERPICTURESROTATEDERROR',	'An error occured while trying to rotate the image!');
define('_USERPICTURESROTATEPICTURE',	'rotate the picture');
define('_USERPICTURESWITHCLOCK',	'clockwise');
define('_USERPICTURESAGAINSTCLOCK',	'anti-clockwise');
define('_USERPICTURESGALLERYVIEW',	'Go to my own user gallery');
define('_USERPICTURESONTOP',		'move up');
define('_USERPICTURESDOWN',		'move down');
define('_USERPICTURECOMMENTCHANGED',	'comment was updated');
define('_USERPICTURESUPDATE',		'update');
define('_USERPICTURESMODIFYCOMMENT',	'update comment');
define('_USERPICTURESAMOUNT',		'Number of uploaded pictures');
define('_USERPICTURESCOMMENTCHANGEERROR',	'An error occured while trying to change a comment');
...
define('_USERPICTURESSUBMIT',		'submit');
define('_USERPICTURESEXISTINGCATS',	'Created categories');
define('_USERPICTURESCATTITLE',		'Title');
define('_USERPICTURESCATTEXT',		'Description');
define('_USERPICTURESDELETECAT',	'Delete a category. Associated pictures will not be deleted. Just the category will be deleted with its associations');
define('_USERPICTURESACTIONDONE',	'...done');
define('_USERPICTURESEDITFAILED',	'An error occured, try again!');
define('_USERPICTURESCATCREATED',	'Category was created');
...
define('_USERPICTURESASSOCIATEDWITH',	'Associated with the following categories:');
...
define('_USERPICTURESMANAGEYOURSETTINGSTEXT',	'You can store some general settings here');
define('_USERPICTURESFORBIDOTHERSTOLINKME',	'I do not want it that other users can link me on their pictures');
define('_USERPICTUREALLOWGUESTSTOSEEMYPICTURES','I also want that guests can view my pictures');
define('_USERPICTURESSUBMITSETTINGS',	'Store general settings');
define('_USERPICTURESSETTINGSSTORED',	'Setings stored');
