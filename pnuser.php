...
function UserPictures_user_managePicture()
{
    ...
    $pnRender->assign('avatarmanagement',pnModGetVar('UserPictures','avatarmanagement'));
    $id = pnVarCleanFromInput('template_id');
    ...
    $categories = pnModAPIFunc('UserPictures','user','getCategories',array('uid'=>$uid));
    if (count($categories)>0) $pnRender->assign('categories',$categories);

    // Return the output that has been generated by this function
    return $pnRender->fetch('userpictures_user_managepicture.htm');
}
