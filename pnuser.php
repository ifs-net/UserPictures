...
function UserPictures_user_settings()
{
    ...
    if ($action=="update") {
		...
		if (!SecurityUtil::confirmAuthKey()) LogUtil::registerAuthIDError();
		    ...
		    $nolinking = 	(int)FormUtil::getPassedValue('nolinking','');
		    $nocomments =	(int)FormUtil::getPassedValue('nocomments','');
		    $picspublic =	(int)FormUtil::getPassedValue('picspublic','');
		    if (pnModAPIFunc('UserPictures','user','storeSettings',array('uid'=>pnUserGetVar('uid'),'nolinking'=>$nolinking,'nocomments'=>$nocomments,'picspublic'=>$picspublic))) LogUtil::registerStatus(_USERPICTURESSETTINGSSTORED);
		}
    }
...
function UserPictures_user_showGallery()
{
	...
	// for testing only to integrate photonotes
	PageUtil::AddVar('javascript','modules/UserPictures/pnincludes/photonotes/PhotoNotes.v1.js');
	PageUtil::AddVar('stylesheet','modules/UserPictures/pnincludes/photonotes/PhotoNotes.v1.css');
